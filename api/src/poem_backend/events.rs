...
impl EventsApi {
    ...
    async fn get_events_by_event_key(
        ...
        fail_point_poem::<BasicErrorWith404>("endpoint_get_events_by_event_key")?;
    ...
    async fn get_events_by_event_handle(
        ...
        fail_point_poem::<BasicErrorWith404>("endpoint_get_events_by_event_handle")?;
        let accept_type = parse_accept::<BasicErrorWith404>(&accept)?;
        let page = Page::new(start.0, limit.0);
...
impl EventsApi {
    fn list(
        ...
        let contract_events = self
            ...
            .get_events(
                &event_key.into(),
                page.start::<BasicErrorWith404>(0, u64::MAX)?,
                page.limit::<BasicErrorWith404>()?,
