...
impl AccountsApi {
    ...
    async fn get_account(
        ...
        fail_point_poem::<BasicErrorWith404>("endpoint_get_account")?;
    ...
    async fn get_account_resources(
        ...
        fail_point_poem::<BasicErrorWith404>("endpoint_get_account_resources")?;
        let accept_type = parse_accept::<BasicErrorWith404>(&accept)?;
        let account = Account::new(self.context.clone(), address.0, ledger_version.0)?;
    ...
    async fn get_account_modules(
        ...
        fail_point_poem::<BasicErrorWith404>("endpoint_get_account_modules")?;
        let accept_type = parse_accept::<BasicErrorWith404>(&accept)?;
        let account = Account::new(self.context.clone(), address.0, ledger_version.0)?;
...
impl Account {
    pub fn new(
        ...
        let latest_ledger_info = context.get_latest_ledger_info_poem::<BasicErrorWith404>()?;
    ...
    pub fn account(self, accept_type: &AcceptType) -> BasicResultWith404<AccountData> {
        ...
        let state_value = self
            .context
            .get_state_value_poem::<BasicErrorWith404>(&state_key, self.ledger_version)?;
    ...
    pub fn resources(self, accept_type: &AcceptType) -> BasicResultWith404<Vec<MoveResource>> {
        ...
        let move_resolver = self.context.move_resolver_poem::<BasicErrorWith404>()?;
